describe("Checkout Process", () => {
  ...
  it("should render the Checkout component", () => {
    cy.get(".flex.flex-col.bg-white.shadow-md.rounded-lg.p-2.space-y-4").should(
      "exist"
    );
    ...
    cy.get("input[name=expirationDate]").should("have.value", "");
    cy.get("input[name=cvv]").should("have.value", "");
    cy.get('[name="cardType"]').should('not.be.checked');
